/*
* sstream : 주어진 문자열에서 필요한 자료형에 맞는 정보를 꺼낼 때 유용(파싱할 때 유용)
*/
...
public:
	...
	friend dynamic_array<T> operator+(const dynamic_array<T>& arr1, dynamic_array<T>& arr2) {
		...
		copy(arr1.begin(), arr1.end(), result.begin()); // 원본 시작 iterator, 원본 끝 iterator, 복사받는 시작 iterator
...
int main() {
	...
	try {
		// class[nStudents] = student{"John", 8};
